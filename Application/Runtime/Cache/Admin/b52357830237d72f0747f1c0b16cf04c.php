...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="graphs">
	     <div class="xs">
  	       <h3>日期规则</h3>
			 <p style="margin-left: 130px;color: red;">请填写不能考勤的日期，格式如 "2017-03-02,2017-03-03,2017-03-02" ，日期以逗号分隔 </p>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">日期列表</label>
									<div class="col-sm-8">
