...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div class="graphs">
	     <div class="xs">
  	       <h3>日期规则</h3>
			 <p style="margin-left: 130px;color: red;">请填写考勤的地点范围，可以精确到小数点第五位  </p>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">考勤地点经度</label>
									<div class="col-sm-8">
										<input type="text" name="longitude" value="<?php echo ($longitude); ?>" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">考勤地点纬度</label>
									<div class="col-sm-8">
										<input type="text" name="latitude" value="<?php echo ($latitude); ?>" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">考勤地点范围</label>
									<div class="col-sm-8">
										<input type="text" name="scope" value="<?php echo ($scope); ?>" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
