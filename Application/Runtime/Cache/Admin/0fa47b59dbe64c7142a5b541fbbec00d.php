						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="name" disabled value="<?php echo ($res["name"]); ?>" class="form-control1" id="focusedinput" placeholder="">
										<input type="hidden" name="userid" disabled value="<?php echo ($res["userid"]); ?>" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="addtime" value="<?php echo ($res["addtime"]); ?>" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">经度</label>
									<div class="col-sm-8">
										<input type="text" name="longitude" value="<?php echo ($res["longitude"]); ?>" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">纬度</label>
									<div class="col-sm-8">
										<input type="text" name="latitude" value="<?php echo ($res["latitude"]); ?>" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="addr" value="<?php echo ($res["addr"]); ?>" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
