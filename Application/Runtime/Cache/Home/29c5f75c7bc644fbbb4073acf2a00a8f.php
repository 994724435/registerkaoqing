...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script type="text/javascript" src="/register/Public/Home/js/weixin_pay.js"></script>
    ...
    <div id="header">
        ...
        <a href="#" class="home"><img src="/register/Public/Home/css/en.png" width="76" height="90"></a>
                ...
                <section id="register1">
                    <div class="paytype">
                        <input id="txt_Email" name="pay" value="1" type="radio"><span>参加医学大会/其他     800元</span>
                    </div>
                    <div class="paytype">
                ...
                <!--     <div class="paytype">
                    ...
                    <input type="submit" value="立即支付" id="registernow" class="weixinPayBtn" data-order_id="1"><br><br>
                    </form>
                </section>
            </form>
        </div>
