...
<style type="text/css">
    ...
    <div id="header">
        <a href="/register/index.php/Home/Article/index" class="back"><img src="/register/Public/Home/css/top_left.jpg" width="76" height="90"></a>
        <?php if($name){echo $name;} ?>
        <!--<a href="#" class="home"><img src="/register/Public/Home/css/en.png" width="76" height="90"></a>-->
    </div>
                <div class="register_title"><img src="/register/Public/Home/css/ico_bg.png">个人中心</div>
                ...
                <section id="register1">
                  ...
                  <!--   <div class="paytype">
                    ...
                    <a href="/register/index.php/Home/Index/user/email/<?php echo $_GET['email']; ?>"><input type="button" value="查看注册类型" id="registernow"></a> <br>
                    <a href="/register/index.php/Home/Index/user/email/<?php echo $_GET['email']; ?>"><input type="button" value="修改个人信息" id="registernow"></a> <br>
                    <a href="/register/index.php/Home/Index/user/email/<?php echo $_GET['email']; ?>"><input type="button" value="退出登录系统" id="registernow" style="background-color: #c2b16b"></a> <br>
                    <br>
                    <!--</form>-->
                </section>
            </form>
