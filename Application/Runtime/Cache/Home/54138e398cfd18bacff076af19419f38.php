...
<style type="text/css">
    ...
    <div id="header">
        ...
        <?php if($name){echo $name;} ?>   （<span>注册ID</span><?php if(￥userid){echo $userid;} ?>）
        <!--<a href="#" class="home"><img src="/register/Public/Home/css/en.png" width="76" height="90"></a>-->
                ...
                <section id="register1">
                    ...
                    </div> /email/<?php echo $_GET['email']; ?> -->
                  <!--   <div class="paytype">
                        <input id="txt_Email" name="pay" value="3" type="radio"><span>青年/学生代表   0元</span>
                    </div> -->
                    <input type="hidden" name="email" value="<?php echo ($email); ?>">
                    <a href="/register/index.php/Home/Index/successuser/email/<?php echo $_GET['email']; ?>"><input type="button" value="查看注册类型" id="registernow"></a> <br>
                    <a href="/register/index.php/Home/Index/user/email/<?php echo $_GET['email']; ?>"><input type="button" value="修改个人信息" id="registernow"></a> <br>
                    <a href="/register/index.php/Home/Article/index"><input type="button" value="退出登录系统" id="registernow" style="background-color: #c2b16b"></a> <br>
                    <br>
                    <!--</form>-->
                </section>
            </form>
