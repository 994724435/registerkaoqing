				...
				case 'subscribe':
					...
					$dataArray = array(
		 							array(
		 								...
		 								"PicUrl"=>"http://www.diaoch.cn/register/welcome.jpg",
		 								"Url"=>"http://www.diaoch.cn/register/index.php/Home/Index/useradd/openid/$openid"
		 								),
		  							array(
		 								"Title"=>"广东省XXX大型公司荣获一等奖",
		 								"Description"=>"this is a test",
				...
				case 'SCAN':
					...
					$dataArray = array(
						array(
							...
							"Url"=>"http://www.diaoch.cn/register/index.php/Home/Index/index/openid/$openid"
						),
						array(
							"Title"=>"广东省XXX大型公司荣获一等奖",
							"Description"=>"this is a test",
...
//							echo $this->replyText($obj,"你的点击的是FAQ事件");
						...
						case 'home':
							...
							$dataArray = array(
								array(
									"Title"=>"上班打卡工作不误",
									"Description"=>"this is a test",
									"PicUrl"=>"http://www.diaoch.cn/register/clock.jpg",
									"Url"=>"http://www.diaoch.cn/register/index.php/Home/Index/index/openid/$openid"
								),
								array(
									"Title"=>"广东省XXX大型公司荣获一等奖",
						...
						default:
							$openid = $obj->FromUserName;
							echo $this->replyText($obj,"该模块正在开发中...");
							break;
					}
					break;
			}	
		...
		private function receiveText($obj){
			...
			$openid = $obj->FromUserName;
			//发送文本消息
			return $this->replyText($obj,$content.$openid);
		}
